const EVENTS = [
  {
    tall: true,
    bg: 'linear-gradient(160deg,#536259,#6B7D6F,#8FA296)',
  ...
  {
    bg: 'linear-gradient(135deg,#081A31,#0E2440)',
  ...
  {
    bg: 'linear-gradient(135deg,#B5713A,#E39156)',
  ...
  {
    bg: 'linear-gradient(135deg,#3A4A40,#6B7D6F)',
  ...
  {
    bg: 'linear-gradient(135deg,#1A2A3A,#2E5080)',
  ...
  {
    bg: 'linear-gradient(135deg,#0E1A2B,#2A1540)',
